...
func (x *greeterSayHelloClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterSayHelloClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *greeterSayHelloServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterSayHelloServer) Recv() (*Request, error) {
	m := new(Request)
